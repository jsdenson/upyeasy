# This is a version of https://github.com/cpopp/MicroTelnetServer/blob/master/utelnet/utelnetserver.py
# The only difference is that the dupterm_notify is added back. Things were not working without it on v1.17
# This is a micropython file. Do not attempt to fix highlighted errors.
...
def accept_telnet_connect(telnet_server):
    ...
    # but apparently is available and needed on v1.17
